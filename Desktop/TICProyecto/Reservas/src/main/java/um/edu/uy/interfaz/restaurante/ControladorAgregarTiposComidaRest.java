    ...
    void agregarMasTiposComida(ActionEvent event) throws IOException {
		...
		if (event.getSource() == btnAgregarMasTiposComida) {
			if (btnTipoComida1.getValue() != null) {
				restauranteMgr.insertarComida(controller.getRutRest(), btnTipoComida1.getValue());
			}
			if (btnTipoComida2.getValue() != null) {
				restauranteMgr.insertarComida(controller.getRutRest(), btnTipoComida2.getValue());
			}
			if (btnTipoComida3.getValue() != null) {
				restauranteMgr.insertarComida(controller.getRutRest(), btnTipoComida3.getValue());
			}
